        ...
        <div className="hidden md:block lg:hidden ">
          <div className="text-green ml-20 mt-12 flex flex-row justify-start">
            <a
              href="https://sail.cive.uh.edu/"
              target="_blank"
              className="border-green text-green hover:bg-textbox-green block h-96 w-72 shadow-xl rounded-lg border-2 bg-offwhite p-4"
            >
              <h1 className="text-xl font-semibold">
                Undergraduate Research <br />
                Assistant @ SAIL Lab
            ...
            <a
              href="https://www.qubitbyqubit.org/programs"
              target="_blank"
              className="border-green text-green hover:bg-textbox-green ml-20 block h-96 shadow-xl w-72 rounded-lg border-2 bg-offwhite p-4"
            >
              <h1 className="text-xl font-semibold">
                UQN Member @ <br /> Qubit x Qubit
              </h1>
