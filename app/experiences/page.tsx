        ...
        <div className="md:hidden lg:block ">
          <div className="text-green mt-12 flex flex-col items-center justify-start lg:ml-20 lg:flex-row lg:items-start">
            ...
            <a
              ...
              target="_blank"
              className="border-green text-green hover:bg-textbox-green mt-12 block h-72 w-72 rounded-lg border-2 bg-white p-4 lg:ml-20 lg:mt-0"
            >
              <h1 className="text-xl font-semibold">
          ...
          <div className="text-green mt-12 flex flex-col items-center justify-start lg:ml-20 lg:flex-row lg:items-start">
            ...
            <a
              href="https://www.codecoogs.com/"
              target="_blank"
              className="border-green text-green hover:bg-textbox-green mb-12 mt-12 block h-72 w-72 rounded-lg border-2 bg-white p-4 lg:mb-0 lg:ml-20 lg:mt-0"
            >
              <h1 className="text-xl font-semibold">
                Executive Intern @ <br />
                Code[Coogs]
