        ...
        <div className="md:hidden lg:block ">
          <div className="text-green mt-12 flex flex-col items-center justify-start lg:ml-20 lg:flex-row lg:items-start">
            <a
              ...
              target="_blank"
              className="border-green text-green hover:bg-textbox-green block h-fit w-72 rounded-lg border-2 bg-offwhite shadow-xl p-4"
            >
            ...
            <a
              ...
              target="_blank"
              className="border-green text-green hover:bg-textbox-green mt-12 block h-fit w-72 rounded-lg border-2 shadow-xl bg-offwhite p-4 lg:ml-20 lg:mt-0"
            >
              <h1 className="text-xl font-semibold">
          ...
          <div className="text-green mt-12 flex flex-col items-center justify-start lg:ml-20 lg:flex-row lg:items-start">
            <a
              ...
              target="_blank"
              className="border-green text-green hover:bg-textbox-green block h-fit w-72 rounded-lg border-2 shadow-xl bg-offwhite p-4"
            >
              <h1 className="text-xl font-semibold">
                Web Developer @ <br />
                CougarCS Web Dev
            ...
            <a
              //href=""
              target="_blank"
              className="border-green text-green hover:bg-textbox-green mt-12 block h-fit w-72 rounded-lg shadow-xl border-2 bg-offwhite p-4 lg:ml-20 lg:mt-0"
            >
              <h1 className="text-xl font-semibold">
            ...
            <a
              href="https://www.codecoogs.com/"
              target="_blank"
              className="border-green text-green hover:bg-textbox-green mb-12 mt-12 block h-fit w-72 shadow-xl rounded-lg border-2 bg-offwhite p-4 lg:mb-0 lg:ml-20 lg:mt-0"
            >
              <h1 className="text-xl font-semibold">
                Executive Intern @ <br />
                Code[Coogs]
        ...
        <div className="hidden md:block lg:hidden ">
          <div className="text-green ml-20 mt-12 flex flex-row justify-start">
            <a
              href="https://sail.cive.uh.edu/"
              target="_blank"
              className="border-green text-green hover:bg-textbox-green block h-fit w-72 shadow-xl rounded-lg border-2 bg-offwhite p-4"
            >
              <h1 className="text-xl font-semibold">
                Undergraduate Research <br />
                Assistant @ SAIL Lab
            ...
            <a
              href="https://www.qubitbyqubit.org/programs"
              target="_blank"
              className="border-green text-green hover:bg-textbox-green ml-20 block h-fit shadow-xl w-72 rounded-lg border-2 bg-offwhite p-4"
            >
              <h1 className="text-xl font-semibold">
                UQN Member @ <br /> Qubit x Qubit
              </h1>
