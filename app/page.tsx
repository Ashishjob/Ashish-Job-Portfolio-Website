  ...
  return (
    <main className="min-w-screen bg-lightgreen flex min-h-screen flex-col">
      ...
      <div className="Heading">
        <div
          className="text-green mt-16 flex flex-row justify-center text-4xl font-semibold hover:underline
         md:mt-36 lg:ml-24 lg:mt-56 lg:justify-start"
        >
          <h1 className="">ASHISH - K - JOB</h1>
        </div>
      ...
      <div className="text-green w=full mt-6 flex-row md:mt-12 md:flex">
