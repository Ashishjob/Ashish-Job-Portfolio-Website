      ...
      <div className="lg:ml-24">
        ...
        <div className="flex flex-row items-center">
          <div className="flex flex-row">
            ...
            <div className="text-green min-w-screen mt-6 w-full flex-row md:mt-12 lg:mt-16 md:flex">
              <div className="ml-24 hidden justify-start lg:block">
                {" "}
              ...
              <div className="min-w-screen flex flex-row">
                <div className="flex flex-col justify-start text-left md:ml-6">
                  ...
                  <h2 className="hidden pt-4 text-left text-xl lg:block">
                    Hey there! My name is Ashish Job, and I am majoring in{" "}
                    <br />
                    Computer Science with a minor in Mathematics at the <br />
                    University of Houston. I&apos;m also incredibly passionate
                    about the <br />
                    fields of Artificial Intelligence and Data Science, and
                    looking <br />
                  ...
                  <h2 className="font-base px-6 text-center text-base sm:hidden">
                    ...
                    University of Houston. I&apos;m also incredibly passionate
                    about the fields of Artificial Intelligence and Data
                    Science, and looking to gain further experience in them!
                    <br />
                    <br />
